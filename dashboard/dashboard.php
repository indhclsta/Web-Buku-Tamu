                ...
                <thead>
                    ...
                    <tbody>
                        <tr class="hover:bg-purple-700 transition-colors">
                            ...
                            <td class="border-t border-purple-500 px-4 py-2">Mica</td>
                            <td class="border-t border-purple-500 px-4 py-2">ca@gmail.com</td>
                            <td class="border-t border-purple-500 px-4 py-2">123-456-7890</td>
                            <td class="border-t border-purple-500 px-4 py-2">TechCorp</td>
                            <td class="border-t border-purple-500 px-4 py-2">None</td>
                            <td class="border-t border-purple-500 px-4 py-2">2025-01-07</td>
                        </tr>
                        <tr class="hover:bg-purple-700 transition-colors">
                            <td class="border-t border-purple-500 px-4 py-2">2</td>
                            <td class="border-t border-purple-500 px-4 py-2">Nan</td>
                            <td class="border-t border-purple-500 px-4 py-2">nan@gmail.com</td>
                            <td class="border-t border-purple-500 px-4 py-2">123-456-7890</td>
                            <td class="border-t border-purple-500 px-4 py-2">ITCorp</td>
                            <td class="border-t border-purple-500 px-4 py-2">None</td>
                            <td class="border-t border-purple-500 px-4 py-2">2025-01-08</td>
                        </tr>
                    </tbody>
                </table>
            </div>
